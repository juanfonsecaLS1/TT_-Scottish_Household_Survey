...
The same approach as in the previous section is followed for the commuting trips, the only difference
is that in this case only the employed population is considered.
